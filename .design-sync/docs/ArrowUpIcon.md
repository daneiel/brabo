---
category: Icones
keywords: [seta, cima, subir, alta]
---

# ArrowUpIcon

Ícone outline do set do Brabo: desenha uma seta para cima. Na app aparece em economia de tokens e tendência de alta.

## Como usar

```tsx
// O componente vem do bundle: window.BraboDS.ArrowUpIcon
...
<ArrowUpIcon size={16} aria-label="uma seta para cima" />
```
