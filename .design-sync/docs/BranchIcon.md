---
category: Icones
keywords: [branch, ramo, git]
---

# BranchIcon

Ícone outline do set do Brabo: desenha uma ramificação de git. Na app aparece em branch de trabalho de um agente.

## Como usar

```tsx
// O componente vem do bundle: window.BraboDS.BranchIcon
...
<BranchIcon size={16} aria-label="uma ramificação de git" />
```
