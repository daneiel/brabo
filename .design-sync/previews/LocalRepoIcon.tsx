/*
 * Preview do LocalRepoIcon. Todos os ícones do set têm a mesma assinatura
...
export function Tamanhos() {
  return (
    <div style={linha}>
      <LocalRepoIcon size={12} />
      <LocalRepoIcon size={14} />
      <LocalRepoIcon size={16} />
      <LocalRepoIcon size={22} />
    </div>
  );
}
