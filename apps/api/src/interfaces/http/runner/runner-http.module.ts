...
@Module({
  ...
  imports: [RunnerUseCasesModule, AuthUseCasesModule],
  ...
  // construtor (PersonalAccessTokenRepository/UserRepository), então
  // precisa estar registrado aqui pro Nest resolver a injeção.
