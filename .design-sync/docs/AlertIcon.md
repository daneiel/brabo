---
category: Icones
keywords: [alerta, atenção, aviso, perigo]
---

# AlertIcon

Ícone outline do set do Brabo: desenha um triângulo de atenção. Na app aparece em urgência de ação e estouro de orçamento.

## Como usar

```tsx
// O componente vem do bundle: window.BraboDS.AlertIcon
...
<AlertIcon size={16} aria-label="um triângulo de atenção" />
```
