---
category: Icones
keywords: [segurança, cadeado, secops, segredo]
---

# LockIcon

Ícone outline do set do Brabo: desenha um cadeado. Na app aparece em o agente SecOps, segredos e campos de token.

## Como usar

```tsx
// O componente vem do bundle: window.BraboDS.LockIcon
...
<LockIcon size={16} aria-label="um cadeado" />
```
