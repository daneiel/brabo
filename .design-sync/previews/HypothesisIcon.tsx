/*
 * Preview do HypothesisIcon. Todos os ícones do set têm a mesma assinatura
 ...
 */
import { HypothesisIcon } from 'web';
...
export function Tamanhos() {
  return (
    <div style={linha}>
      <HypothesisIcon size={12} />
      <HypothesisIcon size={14} />
      <HypothesisIcon size={16} />
      <HypothesisIcon size={22} />
    </div>
  );
}
