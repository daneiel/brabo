---
category: Icones
keywords: [chevron, avançar, navegar]
---

# ChevronRightIcon

Ícone outline do set do Brabo: desenha uma seta fina para a direita. Na app aparece em navegar para dentro e expandir item de lista.

## Como usar

```tsx
// O componente vem do bundle: window.BraboDS.ChevronRightIcon
...
<ChevronRightIcon size={16} aria-label="uma seta fina para a direita" />
```
