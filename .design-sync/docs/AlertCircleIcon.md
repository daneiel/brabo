---
category: Icones
keywords: [alerta, atenção, erro, aviso]
---

# AlertCircleIcon

Ícone outline do set do Brabo: desenha um círculo com exclamação. Na app marca erro de formulário e aviso que exige leitura.

## Como usar

```tsx
// O componente vem do bundle: window.BraboDS.AlertCircleIcon
...
<AlertCircleIcon size={16} aria-label="o ícone" />
```
