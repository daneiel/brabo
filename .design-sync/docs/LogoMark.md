---
category: Icones
keywords: [marca, logo, brabo, wordmark]
---

# LogoMark

Ícone outline do set do Brabo: é a marca do Brabo — as três hastes do wordmark. Aparece no topo da barra lateral e nas telas de auth.

## Como usar

```tsx
// O componente vem do bundle: window.BraboDS.LogoMark
...
<LogoMark size={16} aria-label="o ícone" />
```
