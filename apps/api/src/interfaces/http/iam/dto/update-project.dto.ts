 ...
 * dentro — mudança que exige mover conteúdo, não um `UPDATE`. O ADR 0104
 * (item 4) registrou a intenção de abrir conversão entre os três modos sem
 * recriar o projeto, mas isso NÃO é grátis (é exatamente o que este
 * comentário descreve) — fica para uma onda própria, com desenho dedicado;
 * ver a nota em docs/explanation/backlog.md.
 *
