/*
 * Preview do LayoutSidebarIcon. Todos os ícones do set têm a mesma assinatura
 ...
 */
import { LayoutSidebarIcon } from 'web';
...
export function Tamanhos() {
  return (
    <div style={linha}>
      <LayoutSidebarIcon size={12} />
      <LayoutSidebarIcon size={14} />
      <LayoutSidebarIcon size={16} />
      <LayoutSidebarIcon size={22} />
    </div>
  );
}
