---
category: Icones
keywords: [notificação, sino, aviso]
---

# BellIcon

Ícone outline do set do Brabo: desenha um sino. Na app aparece em o sino de notificações da topbar.

## Como usar

```tsx
// O componente vem do bundle: window.BraboDS.BellIcon
...
<BellIcon size={16} aria-label="um sino" />
```
