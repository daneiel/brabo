---
category: Icones
keywords: [github, provider, repositório]
---

# GitHubIcon

Ícone outline do set do Brabo: desenha o gato-polvo do GitHub. Na app aparece em provider de repositório GitHub.

## Como usar

```tsx
// O componente vem do bundle: window.BraboDS.GitHubIcon
...
<GitHubIcon size={16} aria-label="o gato-polvo do GitHub" />
```
