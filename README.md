...
| [Regras de negócio](docs/business-rules.md) | as 398 RNs, cada uma com `arquivo:linha` e o teste que a cobre |
...
| [ADRs](docs/adr/index.md) | as 154 decisões e o porquê de cada uma |
