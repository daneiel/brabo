...
| `START_GATE_RESCUE` | `true` | tick periódico do resgate de ciclos de gate (`Engine.Gates.GateRescuer`, [RN-136](../business-rules.md#rn-136)). Desligá-lo não muda o boot: o resgate roda uma vez lá de qualquer forma |
...
Inventário extraído do código: **101 variáveis** lidas em tempo de execução. Todas têm descrição nas tabelas acima.
