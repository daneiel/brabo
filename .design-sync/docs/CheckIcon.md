---
category: Icones
keywords: [ok, check, aprovado, concluído]
---

# CheckIcon

Ícone outline do set do Brabo: desenha um visto. Na app aparece em passo concluído e parecer aprovado.

## Como usar

```tsx
// O componente vem do bundle: window.BraboDS.CheckIcon
...
<CheckIcon size={16} aria-label="um visto" />
```
