...
| `agents/` (13) | Criativo, PO, Arquiteto, Dev Lead — cada turno roda numa Task supervisionada (`TurnoAssincrono`, RN-121), não mais dentro do `handle_call`, pra um `:cancel` poder interrompê-lo de verdade | `agents/turno_assincrono.ex` |
