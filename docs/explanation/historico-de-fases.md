---
id: historico-de-fases
title: Histórico de fases
sidebar_label: Histórico de fases
sidebar_position: 14
description: Registro imutável das fases concluídas do Brabo — o que cada uma entregou, cortou e achou, e por quê.
keywords: [histórico, fases, ADR, RN, changelog]
---

# Histórico de fases

> Registro imutável das fases concluídas do Brabo, movido do CLAUDE.md em
> 2026-08-23 sem reescrita. O estado VIGENTE do produto mora no CLAUDE.md,
> nas RNs (docs/business-rules.md) e nos ADRs — este arquivo responde "como
> se chegou aqui", nunca "o que vale hoje". ADR aceito nunca é editado; as
> correções de ADR registradas neste texto continuam válidas onde estão.
...
[backlog.md](backlog.md#backlog-of-the-runnerexecution_mode-adr-0104)):**
...
[ADR 0106](../adr/0106-distribuicao-do-runner-via-tsup-e-npm-publish.md).
