/*
 * Preview do AgentBoxIcon. Todos os ícones do set têm a mesma assinatura
...
export function Tamanhos() {
  return (
    <div style={linha}>
      <AgentBoxIcon size={12} />
      <AgentBoxIcon size={14} />
      <AgentBoxIcon size={16} />
      <AgentBoxIcon size={22} />
    </div>
  );
}
