...
Ícone outline do set do Brabo: desenha um xis. Na app aparece em fechar modal, toast ou painel.

## Como usar

```tsx
// O componente vem do bundle: window.BraboDS.XIcon
...
<XIcon size={16} aria-label="um xis" />
```
