...
- CI/CD de release: GitHub Actions com lógica em scripts testáveis
  ...
  arquivo a mais e a falha apareceria só na máquina de quem instala. Fica
  FORA, declarado: code-signing de SO dos binários (notarização,
  Authenticode) e o proxy de download da api, que segue sem verificar. Ver
