defmodule Engine.Runners.CapacidadesTest do
  ...
  describe "declaradas/1" do
    ...
    test "`espelho` está no vocabulário — nomeável hoje, exigido por ninguém" do
  ...
  describe "exigidas/1" do
    ...
    test "NADA exige `espelho` ainda — quem passa a exigir é a sessão 6" do
