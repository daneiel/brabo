---
category: Icones
keywords: [tempo, relógio, histórico, espera]
---

# ClockIcon

Ícone outline do set do Brabo: desenha um relógio. Na app aparece em estado vazio do feed e marcação de tempo.

## Como usar

```tsx
// O componente vem do bundle: window.BraboDS.ClockIcon
...
<ClockIcon size={16} aria-label="um relógio" />
```
