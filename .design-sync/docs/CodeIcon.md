---
category: Icones
keywords: [código, dev, backend, implementação]
---

# CodeIcon

Ícone outline do set do Brabo: desenha sinais de maior e menor. Na app aparece em o agente Dev Backend.

## Como usar

```tsx
// O componente vem do bundle: window.BraboDS.CodeIcon
...
<CodeIcon size={16} aria-label="sinais de maior e menor" />
```
