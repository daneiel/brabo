...
| [Regras de negócio](docs/business-rules.md) | as 357 RNs, cada uma com `arquivo:linha` e o teste que a cobre |
...
| [ADRs](docs/adr/index.md) | as 134 decisões e o porquê de cada uma |
