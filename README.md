...
| [Regras de negócio](docs/business-rules.md) | as 353 RNs, cada uma com `arquivo:linha` e o teste que a cobre |
...
| [ADRs](docs/adr/index.md) | as 131 decisões e o porquê de cada uma |
