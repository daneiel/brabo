---
category: Icones
keywords: [terminal, comando, shell]
---

# TerminalIcon

Ícone outline do set do Brabo: desenha um prompt de terminal. Na app aparece em ação de terminal aguardando aprovação.

## Como usar

```tsx
// O componente vem do bundle: window.BraboDS.TerminalIcon
...
<TerminalIcon size={16} aria-label="um prompt de terminal" />
```
